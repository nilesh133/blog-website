...
import { updateProfessionAction } from "../store/asyncMethods/ProfileMethods";
import toast, { Toaster } from 'react-hot-toast';
import { RESET_PROFILE_ERRORS } from "../store/types/ProfileTypes";
import { useHistory } from "react-router-dom";
const UpdateProfession = () => {
    const { user: { profession, _id } } = useSelector((state) => state.AuthReducer);
    ...
    const updateProfessionMethod = (e) => {
        e.preventDefault();
        dispatch(updateProfessionAction({ profession: userProfession, id: _id }));
    }
    ...
    return !loading ? <div className="container mt-96">
        ...
        <div className="row ml-minus-16 mr-minus-16">
            ...
            <div className="col-8" style={{ padding: "1rem" }}>
                <div className="card__h3">Update Profession</div>
                <div className="group">
                <div className="card__h3__small">Your Previous Profession</div>
                    <input type="text"
                ...
                <form onSubmit={updateProfessionMethod}>
                    <div className="group">
                    <div className="card__h3__small">Enter Your New Profession</div>
                        <input type="text"
                            className="group__control"
